...
import { PlannerTransitionLoader } from "@/components/planner-transition-loader"
...
export function ItineraryPlanner({ onBack, onNavigateView }) {
  const [showTransitionLoader, setShowTransitionLoader] = useState(true)
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-[#11100E] text-foreground pt-24 pb-20 relative overflow-hidden font-button">
      {/* Overview Search -> Planner Transition Overlay */}
      <AnimatePresence>
        {showTransitionLoader && (
          <PlannerTransitionLoader onComplete={() => setShowTransitionLoader(false)} />
        )}
      </AnimatePresence>
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4 border-b border-border/60 pb-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="rounded-xl bg-[#8E5AB5] text-white hover:bg-[#7B4A9E] font-medium text-xs uppercase tracking-wider px-5 py-2.5 shadow-md shadow-[#8E5AB5]/30 flex items-center gap-2 cursor-pointer transition-all font-button"
            >
          ...
          <div className="relative min-w-[300px] sm:min-w-[400px]">
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border-none bg-[#DDD0EA] dark:bg-[#2A1F33] pl-11 pr-28 py-3 text-xs font-medium text-[#100B12] dark:text-foreground placeholder-[#100B12]/60 dark:placeholder-muted-foreground outline-none font-button"
              />
              <Button
                type="submit"
                size="sm"
                className="absolute right-1.5 rounded-xl bg-[#8E5AB5] text-white hover:bg-[#7B4A9E] text-xs font-medium px-5 py-2 shadow-sm font-button"
              >
                Search
              </Button>
            </form>
      ...
      <div
        ...
        className="w-full border-y border-border/80 bg-background dark:bg-[#18131B] overflow-hidden flex flex-col lg:flex-row gap-0 items-stretch my-2 transition-all rounded-none"
      >
          ...
          <AnimatePresence mode="wait">
            {isMapVisible ? (
              <motion.div
                ...
                className="relative flex flex-col h-[640px] border-b lg:border-b-0 lg:border-r border-border/80 shrink-0 bg-background dark:bg-[#18131B] overflow-hidden shadow-[inset_-12px_0_20px_-8px_rgba(0,0,0,0.06)]"
              >
                {/* Minimal Left Page Atlas Header */}
                <div className="flex items-center justify-between px-4 py-2 border-b border-border/60 bg-background dark:bg-[#18131B] text-xs font-semibold text-muted-foreground shrink-0 font-button">
              ...
              <motion.div
                ...
                className="relative flex flex-col border-b lg:border-b-0 lg:border-r border-border/80 bg-background dark:bg-[#18131B] p-6 space-y-6 shrink-0 shadow-[inset_-12px_0_20px_-8px_rgba(0,0,0,0.06)] overflow-y-auto max-h-[640px]"
              >
                <div className="border-b border-border/80 pb-4 space-y-1">
                  <div className="flex items-center justify-between">
                    <h3 className="font-heading text-lg font-bold text-foreground flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-[#8E5AB5] dark:text-[#86B3E6]" />
                      Trip Preferences
                    </h3>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs font-medium">
                    <button
                      ...
                      className={`p-3 rounded-xl text-center transition-all cursor-pointer flex items-center justify-center gap-1.5 font-button ${
                        destPlanningMode === "explore"
                          ? "bg-muted dark:bg-[#8E5AB5] text-foreground dark:text-white font-medium shadow-xs"
                          : "bg-muted/50 dark:bg-neutral-800 text-muted-foreground hover:bg-muted dark:hover:bg-[#8E5AB5]/30 hover:text-foreground"
                      }`}
                    >
                  ...
                  {destPlanningMode === "explore" ? (
                    <div className="relative">
                      <select
                        ...
                        className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] cursor-pointer appearance-none font-button"
                      >
                    ...
                    <div className="relative flex items-center">
                      <MapPin className="absolute left-3.5 h-4 w-4 text-[#8E5AB5] shrink-0" />
                      <input
                        type="text"
                        ...
                        className="w-full rounded-xl border border-border bg-background pl-9 pr-3 py-2.5 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] font-button"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between rounded-xl border border-border bg-background px-4 py-3 text-xs font-medium text-foreground shadow-sm hover:border-[#8E5AB5] transition-all cursor-pointer font-button"
                  >
                    <div className="flex items-center gap-2.5">
                      <Calendar className="h-4 w-4 text-[#8E5AB5] dark:text-[#86B3E6]" />
                  ...
                  {calendarOpen && (
                    ...
                    >
                      <div className="flex items-center justify-between border-b border-border/80 pb-2">
                        ...
                        <Button size="sm" onClick={() => setCalendarOpen(false)} className="rounded-xl bg-[#8E5AB5] text-xs font-medium text-white px-3 py-1 font-button">Set</Button>
                      </div>
                          ...
                          return (
                            <button
                              ...
                              className={`py-1.5 text-xs font-medium transition-all font-button ${
                                isStart || isEnd
                                  ? "bg-[#8E5AB5] text-white rounded-lg font-medium shadow-md scale-105"
                                  : isInRange
                                    ? "bg-[#8E5AB5]/15 text-[#8E5AB5] dark:text-[#86B3E6] font-medium rounded-sm border-y border-[#8E5AB5]/30"
                    ...
                    {["Relaxed", "Balanced", "Packed"].map((style) => (
                      <button
                        ...
                        className={`rounded-xl border p-2.5 text-xs font-medium transition-all cursor-pointer font-button ${
                          travelStyle === style
                            ? "border-[#8E5AB5] bg-[#8E5AB5]/15 text-[#8E5AB5] dark:text-[#86B3E6] font-medium shadow-sm"
                ...
                <Button
                  ...
                  className="w-full rounded-xl bg-[#8E5AB5] py-3.5 font-medium text-white hover:bg-[#7B4A9E] shadow-md shadow-[#8E5AB5]/30 disabled:opacity-50 cursor-pointer transition-all font-button"
                >
                  {isGenerating ? (
          ...
          <div
            ...
            className="hidden lg:flex w-2.5 bg-muted/60 hover:bg-[#8E5AB5]/30 border-x border-border/60 cursor-col-resize items-center justify-center transition-colors group shrink-0 select-none z-20"
            title="Drag left/right to resize split width"
          >
              <div className="h-8 w-1 rounded-full bg-muted-foreground/40 group-hover:bg-[#8E5AB5] transition-colors flex items-center justify-center">
          ...
          <div
            ...
            className="flex-1 flex flex-col p-5 sm:p-7 space-y-6 overflow-y-auto bg-background dark:bg-[#11100E]"
          >
            ...
            {!itinerary || itinerary.length === 0 || !destination ? (
              <div className="rounded-3xl border border-dashed border-border bg-card/60 p-12 text-center space-y-4 flex flex-col items-center justify-center min-h-[420px]">
                <div className="h-16 w-16 rounded-full bg-[#8E5AB5]/15 text-[#8E5AB5] dark:text-[#86B3E6] flex items-center justify-center">
                ...
                {destination && (
                  <Button
                    onClick={() => handleGenerate()}
                    className="rounded-xl bg-[#8E5AB5] px-6 py-2.5 font-medium text-white shadow-md hover:bg-[#7B4A9E] font-button"
                  >
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-3xl border border-border bg-card p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm">
                  <div className="space-y-1">
                    <div className="text-xs font-semibold text-[#8E5AB5] dark:text-[#86B3E6] uppercase tracking-wider flex items-center gap-1.5 font-button">
                      <MapPin className="h-3.5 w-3.5 text-[#8E5AB5] dark:text-[#86B3E6]" />
                  ...
                  <div className="flex items-center gap-2.5 shrink-0">
                    <Button
                      ...
                      className="rounded-xl border-none bg-muted hover:bg-accent text-foreground text-xs font-medium px-4 py-2 flex items-center gap-1.5 cursor-pointer transition-all font-button"
                    >
                ...
                <div className="flex flex-col gap-4 w-full">
                    ...
                    {itinerary.map((dayPlan, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all cursor-pointer text-left font-button shrink-0 border-none ${
                            isActive
                              ? "bg-[#8E5AB5] text-white font-medium shadow-md"
                        ...
                        >
                          ...
                          <span className={`h-5 w-5 rounded-full flex items-center justify-center text-[10px] font-medium ${
                            isActive ? "bg-amber-400 text-neutral-900 shadow-2xs" : "bg-background text-muted-foreground"
                          }`}>
                  ...
                  <div className="w-full rounded-3xl border border-border bg-card p-6 shadow-sm space-y-4">
                    ...
                    <div className="flex items-center justify-between border-b border-border/80 pb-4">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-[#8E5AB5] text-white flex items-center justify-center font-medium text-sm shrink-0 shadow-sm">
                            ...
                            <div
                              ...
                              className={`group relative rounded-2xl p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all cursor-grab active:cursor-grabbing font-button ${
                                hasCrowdAlert
                                  ...
                                  : draggedSpotIdx === idx
                                  ? "opacity-30 border-dashed border-border bg-muted/20 scale-[0.98]"
                                  : dragOverSpotIdx === idx
                                  ? "border-2 border-border bg-muted/40 shadow-md scale-[1.01]"
                            ...
                            >
                              <div className="flex items-center gap-3 min-w-0 flex-1">
                                ...
                                <div
                                  ...
                                  className="h-11 w-11 rounded-full overflow-hidden border-2 border-border shrink-0 cursor-pointer hover:scale-105 transition-transform"
                                ...
                                <div className="min-w-0 flex-1" id={`itinerary-spot-${act.id || idx}`}>
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="rounded-full bg-muted text-foreground font-medium text-[11px] px-2.5 py-0.5 shrink-0">
                                      {act.cost}
                                    </span>
                                  </div>
                              ...
                              <div className="flex items-center justify-between sm:justify-end gap-2 pt-2 sm:pt-0 border-t sm:border-t-0 border-border/60">
                                <button
                                  type="button"
                                  onClick={() => setActiveSpotDetail({ ...act, dayIndex: activeDayIndex, spotIndex: idx })}
                                  className="rounded-xl border-none bg-muted text-foreground hover:bg-accent px-3.5 py-1 text-xs font-medium transition-all flex items-center gap-1 cursor-pointer shadow-xs font-button"
                                >
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-border">
                      <Button
                        ...
                        className="rounded-xl bg-[#8E5AB5] text-white hover:bg-[#7B4A9E] font-medium text-xs px-5 py-2.5 shadow-md shadow-[#8E5AB5]/25 flex items-center gap-1.5 cursor-pointer font-button"
                      >
      ...
      <div className="fixed bottom-6 left-6 z-50 flex items-center gap-2.5">
        <button
          ...
          className="rounded-xl bg-[#8E5AB5] text-white hover:bg-[#7B4A9E] font-medium text-xs px-4 py-2.5 shadow-md hover:shadow-lg transition-all flex items-center cursor-pointer font-button"
        >
        ...
        {checklistOpen && (
          <div className="fixed bottom-6 left-6 z-[2000] pointer-events-none flex items-end justify-start">
            <motion.div
              ...
              className="pointer-events-auto relative w-full max-w-md overflow-hidden rounded-xl border border-border bg-background dark:bg-card text-foreground shadow-2xl p-6 sm:p-7 space-y-4 cursor-grab active:cursor-grabbing"
            >
              {/* Drag Handle Bar */}
              <div className="flex items-center justify-between border-b border-border pb-3 select-none">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-0.5 font-medium">
                    Auto-tuned for <span className="font-semibold text-foreground">{destination || "Trip"}</span>
                  </p>
                </div>
                <button
              ...
              >
                <input
                  ...
                  className="flex-1 rounded-xl border border-border bg-background px-4 py-2.5 text-xs text-foreground outline-none focus:border-[#8E5AB5]"
                />
                <Button type="submit" className="rounded-xl bg-[#8E5AB5] text-white px-4 py-2.5 text-xs font-medium hover:bg-[#7B4A9E] font-button">
                  <Plus className="h-4 w-4" />
                </Button>
              </form>
                ...
                {checklistItems.map((item) => (
                  <div
                    ...
                    className={`flex items-center justify-between p-3 rounded-xl border transition-all cursor-pointer ${item.checked
                        ? "bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300 opacity-75"
                        : "bg-muted/50 border-border text-foreground hover:bg-muted hover:shadow-md"
                      }`}
                  >
                    <div className="flex items-center gap-3">
                      <div className={`h-5 w-5 rounded-lg border flex items-center justify-center transition-colors ${item.checked ? "bg-emerald-500 border-emerald-500 text-white" : "border-border bg-background"
                        }`}>
                      ...
                      <div>
                        ...
                        <span className="text-[9px] font-medium text-muted-foreground">{item.category}</span>
                      </div>
                    </div>
        ...
        {notesOpen && (
          <div className="fixed bottom-6 right-6 z-[2000] pointer-events-none flex items-end justify-end">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.9, y: 20 }}
              className="pointer-events-auto relative w-full max-w-md overflow-hidden rounded-xl border border-border bg-background dark:bg-card text-foreground shadow-2xl cursor-grab active:cursor-grabbing"
            >
              ...
              {notesView === "list" ? (
                ...
                <div className="p-6 sm:p-8 space-y-5">
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-[#8E5AB5] text-white hover:bg-[#7B4A9E] font-medium text-xs py-3 transition-all cursor-pointer font-button flex items-center justify-center gap-2 shadow-md"
                  >
                    <Plus className="h-4 w-4" />
                    Add New Note
                  </button>
                  ...
                  <div className="max-h-72 overflow-y-auto space-y-3 pr-1">
                    {personalNotes.length === 0 ? (
                      ...
                      personalNotes.map((note) => (
                        <div key={note.id} className="p-3.5 rounded-xl border border-border bg-muted/30 space-y-1.5 hover:bg-muted hover:shadow-sm transition-all">
                          <div className="flex items-center justify-between">
                ...
                >
                  <input
                    ...
                    className="w-full rounded-xl border border-border bg-background p-3 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] transition-colors"
                  />
                  <textarea
                    ...
                    rows={4}
                    className="w-full rounded-xl border border-border bg-background p-3 text-xs text-foreground outline-none focus:border-[#8E5AB5] transition-colors resize-none"
                  />
                  <div className="flex gap-3">
                    <button
                      type="button"
                      onClick={() => setNotesView("list")}
                      className="flex-1 rounded-xl border border-border text-foreground hover:bg-muted py-2.5 text-xs font-medium transition-all cursor-pointer font-button"
                    >
                      Cancel
                    </button>
                    <Button type="submit" className="flex-1 rounded-xl bg-[#8E5AB5] text-white py-2.5 text-xs font-medium hover:bg-[#7B4A9E] shadow-sm font-button">
                      Save Note
                    </Button>
                  </div>
                </form>
        ...
        {miniGoogleOpen && (
          <div className="fixed top-24 right-6 z-40 w-full max-w-xl h-[560px] pointer-events-auto">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.9, y: 20 }}
              className="w-full h-full rounded-xl border-2 border-border bg-card text-card-foreground shadow-2xl overflow-hidden flex flex-col"
            >
              {/* Web Search Tab Bar Header */}
              <div className="flex items-center justify-between bg-[#8E5AB5] text-white px-5 py-3 border-b border-[#7B4A9E]">
                <div className="flex items-center gap-2">
                ...
                >
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border bg-background pl-9 pr-3 py-2 text-xs font-semibold text-foreground outline-none focus:border-[#8E5AB5] focus:ring-2 focus:ring-[#8E5AB5]/10"
                    />
                  </div>
                  <Button type="submit" size="sm" className="rounded-xl bg-[#8E5AB5] text-white text-xs font-medium px-4 py-2 hover:bg-[#7B4A9E] font-button shadow-xs">
                    Search
                  </Button>
                </form>
              </div>
              ...
              <div className="bg-muted/50 px-4 py-2 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground font-semibold">
          ...
          <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4 bg-background/80 backdrop-blur-md">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-border pb-4">
                <div className="flex items-center gap-2.5">
                  <div className="h-10 w-10 rounded-xl bg-[#8E5AB5]/15 text-[#8E5AB5] dark:text-[#86B3E6] flex items-center justify-center font-medium">
              ...
              <form onSubmit={handleAddCustomSpotSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <MapPin className="absolute left-3.5 h-4 w-4 text-[#8E5AB5] dark:text-[#86B3E6]" />
                    <input
                      type="text"
                      required
                      ...
                      className="w-full rounded-xl border border-border bg-background pl-10 pr-4 py-2.5 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] font-button"
                      autoFocus
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] cursor-pointer font-button"
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] cursor-pointer"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-2xl border border-border bg-background px-3.5 py-2 text-xs font-medium text-foreground outline-none focus:border-[#8E5AB5] resize-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-border">
                  ...
                  <Button
                    type="submit"
                    className="rounded-xl bg-[#8E5AB5] text-white hover:bg-[#7B4A9E] font-medium text-xs px-5 py-2 shadow-md cursor-pointer flex items-center gap-1.5 font-button"
                  >
                    <Plus className="h-4 w-4" />
                    Add to Itinerary
                  </Button>
